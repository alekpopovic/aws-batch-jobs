...
variable "container_command" {
  description = "Container command used as AWS container_command or GCP container_commands."
  type        = list(string)
  default     = ["sh", "-c", "echo 'Hello from scheduled batch'; date; env"]
}
...
variable "tags" {
  description = "AWS tags. For GCP, these are converted to lowercase labels."
  type        = map(string)
  default     = {}
}
