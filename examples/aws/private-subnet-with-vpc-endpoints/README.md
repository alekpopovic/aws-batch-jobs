...
- `modules/aws/scheduled-batch-job` for the EventBridge Scheduler, Step Functions, and AWS Batch Fargate flow.
- `modules/aws/vpc-endpoints-fargate` for private access to ECR, CloudWatch Logs, and S3.
